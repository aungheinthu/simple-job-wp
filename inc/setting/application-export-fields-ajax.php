<?php
add_action('wp_ajax_sjw_save_application_export_fields', 'handle_sjw_application_export_fields_form'); // for logged-in users
add_action('wp_ajax_nopriv_sjw_save_application_export_fields', 'handle_sjw_application_export_fields_form'); // for non-logged-in users

function handle_sjw_application_export_fields_form() {
    ...
    if (isset($_POST['nonce']) && wp_verify_nonce($_POST['nonce'], 'sjw_nonce_action')) {
        ...
        update_option('sjw_application_export_fields', $fields);
