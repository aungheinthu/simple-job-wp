<?php
$saved_fields = get_option('sjw_application_form_fields', []); // Retrieve saved fields
?>
<div class="wrap">
    <form method="POST" action="" id="sjw_application_form">
                ...
                <?php foreach ($saved_fields as $index => $field) : ?>
                    <div class="dynamic-field">
                        ...
                        <div class="part-1">
                            ...
                            <select name="field_type[<?php echo $index; ?>]" required class="field-type-select">
                            ...
                            <input type="text" class="field_id" name="field_id[<?php echo $index; ?>]" placeholder="Enter the field ID here" value="<?php echo esc_attr($field['field_id']); ?>" required <?php echo ($field['status'] == 'default') ? 'readonly' : ''; ?>>
                            <input type="text" name="field_label[<?php echo $index; ?>]" placeholder="Field Label" value="<?php echo esc_attr($field['label']); ?>" required>
                            <input type="text" name="field_placeholder[<?php echo $index; ?>]" placeholder="Placeholder (for text/textarea)" value="<?php echo esc_attr($field['placeholder']); ?>">
                            <input type="hidden" name="field_status[<?php echo $index; ?>]" value="<?php echo ($field['status'] == 'default') ? 'default' : 'custom'; ?>">
                            <input type="hidden" name="field_position[<?php echo $index; ?>]" value="<?php echo $index; ?>">
                        </div>
                        ...
                        <div class="part-2">
                            ...
                            <input type="text" name="field_options[<?php echo $index; ?>]" placeholder="Comma-separated values" value="<?php echo esc_attr($field['options']); ?>" class="field-options" <?php echo ($field['type'] === 'select' || $field['type'] === 'checkbox' || $field['type'] === 'radio') ? '' : 'style="display: none;"'; ?>>
                        </div>
                            ...
                            <div class="condition-fields" style="display: <?php echo ($field['enable_condition'] === 'on') ? 'block' : 'none'; ?>;">
                                <div class="condition-fields-wrapper">
                                    <label>
                                        ...
                                        <select name="field_condition_field[<?php echo $index; ?>]">
                                    ...
                                    <label>
                                        Condition:
                                        <select name="field_condition_operator[<?php echo $index; ?>]">
                                    ...
                                    <label>
                                        Condition Value:
                                        <input type="text" name="field_condition_value[<?php echo $index; ?>]" placeholder="Condition Value" value="<?php echo esc_attr($field['condition_value']); ?>">
                                    </label>
                                </div>
                            </div>
        ...
        <div class="sjw-submit-button-wrap">
            <button id="sjw_save_application_fields" class="button button-primary button-large">Save Changes</button>
