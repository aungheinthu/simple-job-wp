<div class="wrap">
    <form id="application_messages_form" method="post">
        <table class="form-table">
            <!-- Thank You Message -->
            <tr>
                <th>
                    <label for="sjw_application_thank_you_message">Thank You Message</label>
                </th>
                <td>
                    <?php
                    $sjw_application_thank_you_message = get_option('sjw_application_thank_you_message', 'Thank you for your submission! We will get back to you soon.');
                    wp_editor(
                        $sjw_application_thank_you_message,
                        'sjw_application_thank_you_message', // ID of the editor
                        [
                            'textarea_name' => 'sjw_application_thank_you_message', // Name attribute for form submission
                            'textarea_rows' => 16,
                            'media_buttons' => true,
                            // 'teeny' => false,
                            // 'tinymce' => [
            ...
            <tr>
                <th>
                    <label for="sjw_application_redirect_page">Redirect Page</label>
                </th>
                <td>
                <?php
                    $sjw_application_redirect_page = get_option('sjw_application_redirect_page', '');
                    ...
                    <select id="sjw_application_redirect_page" name="sjw_application_redirect_page">
                        <option value="">— Select a Page —</option>
                        <?php foreach ($filtered_pages as $page): ?>
                            <option value="<?php echo esc_attr($page->ID); ?>" <?php selected($page->ID, $sjw_application_redirect_page); ?>>
