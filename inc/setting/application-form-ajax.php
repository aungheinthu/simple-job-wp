<?php
add_action('wp_ajax_sjw_save_application_form_fields', 'handle_sjw_application_form'); // for logged-in users
add_action('wp_ajax_nopriv_sjw_save_application_form_fields', 'handle_sjw_application_form'); // for non-logged-in users

function handle_sjw_application_form() {
